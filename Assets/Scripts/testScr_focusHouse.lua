...
-- カメラを揺らす演出
local speedShake = 100
local YShake = 10        -- 減衰させながら使用
local YShakeMinus = 0.8
local YThresholdStop = 6
...
-- 数値の線形補間
function LinerIP_num(argOri,argTar,argTimeEnd,argTimePast)
...
-- 三次元ベクトルの線形補間
function LinerIP_vec3(vecOri,vecTar,argTimeEnd,argTimePast)
